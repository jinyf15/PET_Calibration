...
void phGlobalPosi(struct detector *det,int iDet,double *sysPa)
{
    ...
    printf("nph_Det %d iph %d phCenter %lf %lf %lf \n",det[iDet].nphPerDet,iph,det[iDet].phCenter[iph][0],det[iDet].phCenter[iph][1],det[iDet].phCenter[iph][2]);
    printf("nph_Det %d iph %d phX %lf %lf %lf \n",det[iDet].nphPerDet,iph,det[iDet].phX[iph][0],det[iDet].phX[iph][1],det[iDet].phX[iph][2]);
    printf("nph_Det %d iph %d phY %lf %lf %lf \n",det[iDet].nphPerDet,iph,det[iDet].phY[iph][0],det[iDet].phY[iph][1],det[iDet].phY[iph][2]);
    printf("nph_Det %d iph %d phZ %lf %lf %lf \n",det[iDet].nphPerDet,iph,det[iDet].phZ[iph][0],det[iDet].phZ[iph][1],det[iDet].phZ[iph][2]);
