...
void linbcg1_multipoints_eff_rebin2(unsigned long n, unsigned long m, int NROW, int NCOL, double b[], double x[], int itol, float tol,
	int itmax, int *iter, float *err)
{
	...
	double *p,*pp,*r,*rr,*z,*zz, *diag, *diag_tmp;
    char filename[500];
	FILE *fp1;
